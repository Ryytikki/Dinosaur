...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "dino_game.py"
 
        #Name of program
        self.project_name = "Dinomine"
        ...
        self.license = "Creative commons Non-commercial share alike"
 
        #Auhor of program
        self.author_name = "Morgan F. and Thomas M."
        self.author_email = "migit_2005@hotmail.com"
        self.copyright = "Copyright (c) 2013 Morgan F."
 
        #Description
        self.project_description = "BETA 0.9.0"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = [os.path.join("Images"), os.path.join("Classes"), os.path.join("sfx"), os.path.join("Menus"), os.path.join("Cutscenes")]
 
        #Extra/excludes python modules
        self.extra_modules = ["ctypes"]
        self.exclude_modules = ["numpy", "pyglet"]
